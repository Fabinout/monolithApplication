package io.github.monolith.application.config;
...
@Configuration
@EnableJpaRepositories("io.github.monolith.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.github.monolith.application.repository.search")
